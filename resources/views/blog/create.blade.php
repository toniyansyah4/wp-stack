                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('blog.store') }}" method="POST">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="title" id="title" class="border-2 rounded-md p-2">
                        </div>
                        <div class="flex flex-col mt-4">
                            <label for="content" class="text-lg">Content</label>
                            <textarea name="content" id="content" cols="30" rows="10" class="border-2 rounded-md p-2"></textarea>
                        </div>
                        <div class="flex flex-col mt-4">
                            <button type="submit"
